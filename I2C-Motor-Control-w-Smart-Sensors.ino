...
//Use Wire.h for Arduino Uno and replace "TinyWireM." with "Wire."
int angle, old_angle, angle_change, RPM, current; //Sensor values
byte Dir; //Angle sensor direction
...
//Read current
TinyWireM.requestFrom(8,2); //Current sensor (Arduino I²C address = 8; 2 bytes)
